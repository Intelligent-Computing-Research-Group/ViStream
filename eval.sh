...
# CUDA_VISIBLE_DEVICES=$2 python -u test/test_vos.py --config $CFG_PATH --QANNPath /home/kang_you/SpikeZIP_transformer/output/T-SNN_resnet50_imagenet_relu_QANN_QAT_act16_weightbit32/checkpoint-90.pth \
...
# CUDA_VISIBLE_DEVICES=$2 python -u test/test_mot.py --config $CFG_PATH --QANNPath /home/kang_you/SpikeZIP_transformer/output/T-SNN_resnet50_imagenet_relu_QANN_QAT_act16_weightbit32/checkpoint-29.pth \
...
CUDA_VISIBLE_DEVICES=$2 python -u test/test_mots.py --config $CFG_PATH --QANNPath /home/kang_you/SpikeZIP_transformer/output/T-SNN_resnet50_imagenet_relu_QANN_QAT_act16_weightbit32/checkpoint-90.pth \
