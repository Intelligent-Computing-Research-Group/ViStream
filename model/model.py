...
def make_encoder(args):
    ...
    if model_type == 'crw':
        ...
        net = resnet.resnet50(pretrained=True, dataLen=args.dataLen, record_inout=args.record_inout)
    elif model_type == 'spikeimagenet50':
        # need args: QANNPath, level, weight_quantization_bit, time_step, encoding_type, record_inout, log_dir
        net = resnet.spikeresnet50(pretrained=True, QANNPath=args.QANNPath, level=args.level,weight_quantization_bit=args.weight_quantization_bit,\
                                   time_step=args.time_step,encoding_type=args.encoding_type,record_inout=args.record_inout,log_dir=args.log_dir,dataLen=args.dataLen)
    elif model_type == 'spikeimagenet50LCC':
        # need args: QANNPath, level, weight_quantization_bit, time_step, encoding_type, record_inout, log_dir
        net = resnet.spikeresnet50LCC(pretrained=True, QANNPath=args.QANNPath, level=args.level,weight_quantization_bit=args.weight_quantization_bit,\
                                   time_step=args.time_step,encoding_type=args.encoding_type,record_inout=args.record_inout,log_dir=args.log_dir,dataLen=args.dataLen)
    elif model_type == 'spikeimagenet50IF':
        # need args: QANNPath, level, weight_quantization_bit, time_step, encoding_type, record_inout, log_dir
        net = resnet.spikeresnet50IF(pretrained=True, QANNPath=args.QANNPath, level=args.level,weight_quantization_bit=args.weight_quantization_bit,\
                                   time_step=args.time_step,encoding_type=args.encoding_type,record_inout=args.record_inout,log_dir=args.log_dir,dataLen=args.dataLen)
    ...
    if model_type.count("spike") > 0 and hasattr(net.model, 'modify'):
        net.model.modify(remove_layers=args.remove_layers)
